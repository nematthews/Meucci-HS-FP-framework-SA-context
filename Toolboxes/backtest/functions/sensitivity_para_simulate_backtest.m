...
% method.
% (type: Timetable, [T x Q] | array, [T x Q])
%
    ...
    case 'rolling_w'
        ...
        for config1 = 1:size(hyperparameter_set, 2)
            for config2 = 1:size(hyperparameter_set, 2)
                ...
                parameter_configMatrix(col, :) = [hyperparameter_set(1, config1); ...
                    hyperparameter_set(2, config2)];
                col = col + 1;
            end
        end
        ...
        parfor config = 1:parameter_num_configs
            ...
            iterativeClass.HSFPparameters.RollWindow  = parameter_configMatrix(config, 2);
            % assign object
