function [data_simulationCellArray,parameter_simulationCellArray] = simulate_backtest(data_configurationMatrix,parameter_configurationMatrix,base_backtestObject)
