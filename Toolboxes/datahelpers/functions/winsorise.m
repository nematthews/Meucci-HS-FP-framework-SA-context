function [wx,b,ui,li] = winsorise(varargin)
...
%  This transformation is named after the biostatistician C.P. Winsor. 
...
if conv
    ...
    while mean(sy12) > tol
        ...
        [wx(:,ci),b(:,ci),ui(:,ci),li(:,ci)] = winsorise(wx(:,ci),tr,type,false); % winsorize again
        % <----------------
